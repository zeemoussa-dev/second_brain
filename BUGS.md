...
| BUG-076 | The vault index keeps one note per file name, so a same-named note hides another -- a meeting and its same-named invitation message collide, and the meeting disappears from My Day | Logic | Major | Fixed | 2026-09-22 | `cac9a87` |
